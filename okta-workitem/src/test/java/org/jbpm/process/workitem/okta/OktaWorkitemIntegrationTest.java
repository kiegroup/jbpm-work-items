...
public class OktaWorkitemIntegrationTest {
    ...
    public void testWorkitemValidity() {
        ...
        assertTrue(repoResults.containsKey("OktaAddUserToGroup"));
        assertTrue(repoResults.containsKey("OktaCreateGroup"));
        assertTrue(repoResults.containsKey("OktaCreateUser"));
        assertTrue(repoResults.containsKey("OktaGetApplications"));
        assertTrue(repoResults.containsKey("OktaGetUsers"));
    }
}
