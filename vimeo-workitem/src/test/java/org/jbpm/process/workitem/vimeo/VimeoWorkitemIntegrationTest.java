...
public class VimeoWorkitemIntegrationTest {
    ...
    public void testWorkitemValidity() {
        ...
        assertTrue(repoResults.containsKey("DeleteVimeo"));
        assertTrue(repoResults.containsKey("GetInfoVimeo"));
        assertTrue(repoResults.containsKey("UpdateVimeo"));
        assertTrue(repoResults.containsKey("UploadVimeo"));
    }
}
