...
public class SimpleRestServiceWorkItemHandlerTest extends AbstractBaseTest {
    ...
    public void testHandler() throws Exception {
        ...
        SimpleRestServiceWorkItemHandler handler = new SimpleRestServiceWorkItemHandler();
