...
public class SlackWorkitemIntegrationTest {
    ...
    public void testWorkitemValidity() {
        ...
        assertTrue(repoResults.containsKey("SlackPostMessageToChannel"));
        assertTrue(repoResults.containsKey("SlackAddReminder"));
    }
}
