...
public class RiotWorkitemIntegrationTest {
    ...
    public void testWorkitemValidity() {
        ...
        assertTrue(repoResults.containsKey("RiotSummonerInfo"));
        assertTrue(repoResults.containsKey("RiotMatchInfo"));
        assertTrue(repoResults.containsKey("RiotSummonerLastMatch"));
    }
}
