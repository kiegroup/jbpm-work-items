...
public class GoogleTranslateWorkitemIntegrationTest {
    ...
    public void testWorkitemValidity() {
        ...
        assertTrue(repoResults.containsKey("GoogleDetectLanguage"));
        assertTrue(repoResults.containsKey("GoogleTranslate"));
    }
}
