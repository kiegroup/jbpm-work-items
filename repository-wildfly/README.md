...
Unzip the repository-server-7.11.1-SNAPSHOT zip file into a directory
of your choice:

```
unzip jbpm-work-items/repository-wildfly/target/repository-server-7.11.1-SNAPSHOT.zip
```
