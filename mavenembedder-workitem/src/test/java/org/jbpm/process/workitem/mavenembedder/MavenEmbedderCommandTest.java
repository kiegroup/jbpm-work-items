...
public class MavenEmbedderCommandTest {
    ...
    public void testArchetypeGenerateCommandMultiThread() throws Exception {
        ...
        commandContextData.put("Goals",
                               "archetype:generate");
        commandContextData.put("CLOptions",
                               "-B -DarchetypeGroupId=org.kie -DarchetypeArtifactId=kie-service-spring-boot-archetype -DarchetypeVersion=7.18.0-SNAPSHOT -DgroupId=com.company -DartifactId=service -Dversion=1.0-SNAPSHOT -Dpackage=com.company.service -DappType=bpm");
        commandContextData.put("WorkDirectory",
                               simpleTestProjectDir.getAbsolutePath());
        commandContextData.put("ProjectRoot",
                               "");
        ...
        commandContextData2.put("CLOptions",
                                "-B -DarchetypeGroupId=org.kie -DarchetypeArtifactId=kie-kjar-archetype -DarchetypeVersion=7.18.0-SNAPSHOT -DgroupId=com.company -DartifactId=kjar -Dversion=1.0-SNAPSHOT -Dpackage=com.company");
